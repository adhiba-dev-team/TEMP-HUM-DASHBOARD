...
//   return <CustomPickersDay {...other} selected={isSelected} day={day} />;
// }

// export default function MultiDateRangePicker({ onRangeSelect }) {
...
//   // When OK clicked → send confirmed dates to parent (cards)
//   const handleConfirm = () => {
...
// ---- Custom Day (handles DARK/LIGHT mode) ----
const CustomPickersDay = styled(PickersDay)(
  ({ theme, selected, ownerState }) => ({
    ...(ownerState.isDark && {
      color: '#ffffff', // normal text in dark mode
    }),
